...
CREATE TABLE `User` (
    ...
    `role` ENUM('ADMIN', 'STAFF', 'USER', 'WAITER', 'KITCHEN') NOT NULL DEFAULT 'USER',
...
CREATE TABLE `Order` (
    ...
    `status` ENUM('PENDING', 'IN_PROGRESS', 'SERVED', 'CANCELLED', 'IS_PAYED') NOT NULL DEFAULT 'PENDING',
...
CREATE TABLE `Payment` (
    ...
    `otherAmount` DECIMAL(65, 30) NULL,
